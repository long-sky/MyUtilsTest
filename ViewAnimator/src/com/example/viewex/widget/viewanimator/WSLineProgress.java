...
public class WSLineProgress extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //婢跺嫮鎮妏adding閹懎鍠�        mRadius = (int) (Math.min(centerX - getPaddingLeft(), centerX - getPaddingRight()) * RADIUS_RATIO);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setTextSize(DimensionUtil.dip2px(mContext, 20));
            ...
            public void run() {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        mValue = (int) Float.parseFloat(animation.getAnimatedValue().toString());
                        postInvalidate();
                    }
                });
                animator.start();
